...
export const isValidEditorGroup = (group: any): group is EditorGroup => {
  return (
    ...
    (group.activeTabId === undefined || typeof group.activeTabId === 'string') &&
...
export const findGroupById = (state: MainAreaState, groupId: string): EditorGroup | undefined => {
  return state.layout.groups.find((group) => group.id === groupId)
}

export const findTabById = (state: MainAreaState, tabId: string): { tab: Tab; groupId: string } | undefined => {
...
export const getActiveTab = (state: MainAreaState): { tab: Tab; groupId: string } | undefined => {
...
export const getGroupIndex = (state: MainAreaState, groupId: string): number => {
  return state.layout.groups.findIndex((group) => group.id === groupId)
}

export const getTabIndex = (group: EditorGroup, tabId: string): number => {
...
export const validateMainAreaState = (state: any): state is MainAreaState => {
  return (
    ...
    (state.layout.activeGroupId === undefined || typeof state.layout.activeGroupId === 'string') &&
