...
export const name = 'viewlet.main-area-editor-layout-single-merges-two-columns'
export const skip = 1
...
export const test: Test = async ({ Command, FileSystem }) => {
  ...
  assert(savedState.layout.groups[0].size === 100, `Expected merged group size 100, got ${savedState.layout.groups[0].size}`)
}
