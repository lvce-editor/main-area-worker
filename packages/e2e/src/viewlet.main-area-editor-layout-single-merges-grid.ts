...
export const name = 'viewlet.main-area-editor-layout-single-merges-grid'
export const skip = 1
...
export const test: Test = async ({ Command, FileSystem }) => {
  ...
  assert(savedState.layout.groups[0].direction === undefined, 'Expected merged group to have no nested direction')
}
