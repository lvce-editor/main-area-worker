...
export const ConfigureLimit = 'Configure Limit'
...
export const NewTextFile = 'New Text File'
export const NewWindow = 'New Window'
export const OpenFile = 'Open File'
export const OpenAnyway = 'Open Anyway'
export const OpenInTextEditor = 'Open in Text Editor'
export const BinaryFileNotDisplayed = 'The file is not displayed in the text editor because its contents are binary.'
export const LargeFileNotDisplayed = 'The file is not displayed in the text editor because it is very large'
